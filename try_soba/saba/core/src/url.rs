...
impl Url {
    ...
    fn extract_host(&self) -> String {
        let url_parts: Vec<&str> = self
            ...
            .splitn(2, "/")
            .collect(); // if url is http://example.com:433/a/b/c, url_parts should be ['example.com:433', 'a', 'c']
...
mod tests {
    ...
    fn test_url_host_port_path_searchpart() {
        let url = "http://example.com:8888/index.html?a=123&b=234".to_string();
        let expected = Ok(Url {
            url: url.clone(),
            host: "example.com".to_string(),
            port: "8888".to_string(),
            path: "index.html".to_string(),
            searchpart: "a=123&b=234".to_string(),
        });
        assert_eq!(expected, Url::new(url).parse());
    }
    #[test]
